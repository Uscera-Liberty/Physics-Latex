...
Объемная плотность заряда $\rho_q$ - общий заряд который имеется в объеме деленный на объем, то есть заряд в единице объема. Для того чтобы получить заряд в точке уменьшаем объем до точки, то есть делаем бесконечно малый объем.
\[ \rho_q(x,y,x) = \lim_{\Delta x \to 0} \frac{\Delta q}{\Delta V}\]
формула
Поверхностная плотность заряда - то есть на плоскости
формула
Линейная плотность заряда  - собсвенно на линии, когда площадь стремится к нулю соотвественно.

формула

1.Поле бесконечно однородно заряженной плоскости
1.рисунок
...
формула
Первый способ с помощью физических соображений:
\[\Phi_E = \oiint\limits_S \vec E \cdot \vec n dS = \frac{1}{\epsilon_0} \sum_{}^{} q = \frac{1}{\epsilon_0} \sigma \cdot S\]

Второй способ, возьмем тот же цилиндр. Рассмотрим боковую поверхность цилиндра,поверхностный интегрл можно расписать как сумма (формула) нормаль соотвестно к этой поверхности будет перпендикулярно силовым линиям, то есть:
\[ \iint\limits_S_{бок} \vec E \cdot \vec n dS + 2\iint\limits_S_{осн} \vec E \cdot \vec n dS = 2 E \cdot S\]

формула

Получается, можно приравнять, потому что мы считаем одну и ту же площадь одно и того тела разными способами, то есть:
\[E = \frac{\sigma}{2 \epsilon_0}\]
рисунок

2.Электрическое поле двух разноименно заряженных плоскостей.
рисунок
...
2. Поле бесконечного однородно заряженного цилиндра
рисунок
По поверхности цилиндра распределен заряд с плотностью $\sigma$, в силу симметрии наши линии напряженности напряженности будут перпендикулярны поверхности цилиндра.
...
И разобьем на боковые поверхности соотвественно:
На основаниях нормаль будет перпендикурляно заряду, а соответственно нормали н абоковой поверхности будут сонаправлены векторам силового поля, то есть получаем:
\[\oiint\limits_S \vec E \cdot \vec n ds = \iint\limits_S_{бок} \vec E \cdot \vec n dS + 2\iint\limits_S_{осн} \vec E \cdot \vec n dS = E \iint\]
...
3. Сферически однородно заряженная поверхность
рисунок

Линии напряженности будут перпендикулярны поверхности сферы.По аналогии с предыдущими доказательствами, возьмем сферу окружающую нашу сферу и прменим теорему Гаусса:
\[\Phi_E = \oiint\]
формула
В случае сферы, мы можем посчитать общий заряд на сфере и он будет равен:

\[\]

Послденее используют только когда r >> R. Напряженность поля точечного заряда совпадает с этой формулой.

Работа сил электростатического поле.

Рассмотрим два заряда, заряд создающий поле соотвественно и пробный заряд произвольно движущий в этом поле. Нужно посчитать работу по перемещению этого заряда в поле.
Заметим, что действие силы поля напомнинает действие центральной силы, а именно что вектор силы будет на одной линии с неподвижной точкой, к тому же любая центральная сила консервативна и тогда переделы интегрирования будут определяться радиус векторами от первой точки  и от второй соотвественно:
...
Так как наш сила консервативная, то можем ввести понятие потенциальной энергии, то есть: формула (w1 -w2), то есть потенциальная энергия поля
...
Потенциальную энергию поле не принято считать характеристикой этого поля, посокльку зависит от заряда помещенного в это поле. Тогда рассматривают величину потенциальной энергии деленное на величину заряда помещенное в это поле.

Потенциалом электрического поле называется величина равная отношению потенциальной энергии заряженной частицы к величине этого заряда.

формула

Если есть несколько частиц с потенциалами соотвественно формула , то общий потенциал равен сумме этих потенциалов:
